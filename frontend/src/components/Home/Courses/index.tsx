        ...
        <section id="trips">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4'>
                <div className="sm:flex justify-between items-center mb-20">
                    <h2 className="text-midnight_text text-4xl lg:text-5xl font-semibold mb-5 sm:mb-0">Popular trips.</h2>
                    <Link href={'/'} className="text-primary text-lg font-medium hover:tracking-widest duration-500">Explore trips&nbsp;&gt;&nbsp;</Link>
                </div>
                <Slider {...settings}>
                        ...
                        <div key={i}>
                            <div className='bg-white m-3 mb-12 px-3 pt-3 pb-12 shadow-course-shadow rounded-2xl h-full'>
                                <div className="relative rounded-3xl">
                                    <Image src={`${getImagePrefix()}${items.imgSrc}`} alt="trip-image" width={389} height={262} className="m-auto clipPath" />
                                    <div className="absolute right-5 -bottom-2 bg-secondary rounded-full p-6">
                                        <h3 className="text-white uppercase text-center text-sm font-medium">top <br /> pick</h3>
                                    </div>
                                </div>
                                ...
                                <div className="px-3 pt-6">
                                    ...
                                    <div className="flex justify-between pt-6">
                                        <div className="flex gap-4">
                                            ...
                                            />
                                            <h3 className="text-base font-medium text-black opacity-75">{items.classes} days</h3>
                                        </div>
                                        <div className="flex gap-4">
                                            <Icon
                                                ...
                                                className="text-primary text-xl inline-block me-2"
                                            />
                                            <h3 className="text-base font-medium text-black opacity-75">{items.students} travelers</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
